        ...
        <Router>
          <Routes>
            ...
            <Route path="/admin/categories" element={
              <AdminLayout>
                <div className="text-center py-12">
                  <h2 className="text-2xl font-bold text-gray-800 mb-4">Categories Management</h2>
            ...
            <Route path="/admin/tags" element={
              <AdminLayout>
                <div className="text-center py-12">
                  <h2 className="text-2xl font-bold text-gray-800 mb-4">Tags Management</h2>
                  <p className="text-gray-600">Tags management interface will be implemented here.</p>
                </div>
              </AdminLayout>
            } />
